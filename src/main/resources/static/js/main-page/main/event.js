...
document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        const totalDiaries = await recommendService.getTotalDiariesData();
        console.log("totalDiaries:", totalDiaries);
        ...
        showDiaries(recommendedDiaries);
...
const showDiaries = (diaryList) => {
    ...
    diaryList.forEach((diary) => {
        let filePath = diary.memberFilePath || diary.socialImgUrl || 'https://image.ohousecdn.com/i/bucketplace-v2-development/uploads/default_images/avatar.png?w=144&h=144&c=c';
